...
(define xpage
  `(html
    (head
     ...
     (style
         "body { background-color: linen; } .main { width: auto; padding-left: 30px; padding-right: 30px; } .row { padding-top: 10px; } .text { padding-left: 30px; } h2 { margin-bottom: 6px; } p { margin-top: 6px; } .responsive { width: 100%; height: auto; }"
         ))
    (body
     (div ((class "main"))
          (div ((class "text"))
